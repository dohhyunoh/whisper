...
export default function TrialOfferScreen() {
  ...
  useEffect(() => {
    posthog.capture(Events.ONBOARDING_SCREEN_VIEWED, { screen_name: 'trial_offer' });
    titleOpacity.value = withTiming(1, { duration: 600 });
    subtitleOpacity.value = withDelay(300, withTiming(1, { duration: 600 }));
    mascotOpacity.value = withDelay(500, withTiming(1, { duration: 600 }));
    ...
    >
      ...
      >
        ...
        <View style={styles.center}>
          <Animated.Text
            style={[styles.title, { fontSize: 30 * s, lineHeight: 40 * s }, titleStyle]}
          >
            Your growth matters{'\n'} to us
          </Animated.Text>
