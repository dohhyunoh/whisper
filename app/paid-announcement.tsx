...
export default function PaidAnnouncementScreen() {
      ...
      >
        <View style={styles.top}>
          <Animated.View
            ...
            style={[styles.crownBadge, { paddingHorizontal: 14 * s, paddingVertical: 6 * s }]}
          >
            <Ionicons name="star" size={14 * s} color="#3A6B80" />
            <Text style={[styles.crownText, { fontSize: 12 * s }]}>Founding Member</Text>
          </Animated.View>
          ...
          <Animated.Text
            ...
            style={[styles.title, { fontSize: 32 * s, marginTop: 8 * s }]}
          >
            Whisper v2{'\n'}is live.
          </Animated.Text>
        </View>
        ...
        <View style={styles.middle}>
          ...
          >
            <Text style={[styles.body, { fontSize: 16 * s, lineHeight: 24 * s }]}>
              We rebuilt Whisper from the ground up. You now get a tightly curated batch of
              <Text style={styles.bodyEmphasis}> 10 deep quotes a day</Text>, powered by an engine
              that learns from every swipe.
            </Text>
            ...
            <View style={styles.row}>
              ...
              <Text style={[styles.rowText, { fontSize: 14 * s }]}>
                Your price is locked at <Text style={styles.bodyEmphasis}>$9.99/mo</Text> or <Text style={styles.bodyEmphasis}>$49.99/yr</Text>, forever.
              </Text>
            </View>
            <View style={[styles.row, { marginTop: 10 * s }]}>
              <Ionicons name="checkmark-circle" size={20 * s} color="#3A6B80" />
              <Text style={[styles.rowText, { fontSize: 14 * s }]}>
                Nothing to do — thank you for being with Whisper from the start.
              </Text>
            </View>
          </Animated.View>
        </View>
...
const styles = StyleSheet.create({
  ...
  crownText: { color: '#3A6B80', fontWeight: '700', letterSpacing: 0.5 },
  ...
  divider: {
    ...
    backgroundColor: 'rgba(58, 107, 128, 0.2)',
  },
