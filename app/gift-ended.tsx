...
export default function GiftEndedScreen() {
      ...
      >
        <View style={styles.top}>
          ...
          >
            ...
            <Text style={[styles.badgeText, { fontSize: 12 * s }]}>Founding Member</Text>
          </Animated.View>
        ...
        <View style={styles.middle}>
          ...
          >
            <Text style={[styles.body, { fontSize: 16 * s, lineHeight: 24 * s }]}>
              Thank you for being with Whisper from the very beginning. Your{' '}
              <Text style={styles.bodyEmphasis}>30 days as a founding member</Text> have ended.
            </Text>
            <Text style={[styles.body, { fontSize: 16 * s, lineHeight: 24 * s, marginTop: 14 * s }]}>
              Subscribe to keep your daily 10, your saved quotes, and everything you've tuned to you.
            </Text>
          </Animated.View>
        </View>
        ...
        <Animated.View entering={FadeIn.duration(500).delay(1000)} style={styles.btnWrap}>
          ...
          >
            <Text style={[styles.buttonText, { fontSize: 17 * s }]}>Continue with Whisper</Text>
          </Pressable>
